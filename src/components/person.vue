      ...
      <van-tab v-for="(item,index) in dome" :key="index">
        ...
        <div style="background:#fff">
          ...
          <div class="pdf" v-if="zlPdf !==''">
            ...
            ></pdf>
            <div>
              <van-button @click="changePdfPage(0)" style="background-color:#1AC9B9;color:#fff;margin:10px 10px 10px 80px">上一页</van-button>
              {{currentPage}} / {{pageCount}}
              <van-button @click="changePdfPage(1)" style="background-color:#1AC9B9;color:#fff;margin:0 0 0 10px">下一页</van-button>
            </div>
          </div>
        </div>
      </van-tab>
